...
const HospitalCanvas = dynamic(
  () => import("../3d/HospitalCanvas").then((mod) => mod.HospitalCanvas),
  { ssr: false }
);
...
export const CommandCenterView: React.FC<CommandCenterViewProps> = ({ onSelectTab }) => {
  ...
  return (
    <div className="w-full flex flex-col text-white">
      ...
      <div className="flex-1 flex overflow-hidden min-h-[600px] h-[calc(100vh-180px)]">
        {/* Left Sidebar */}
        <Sidebar
